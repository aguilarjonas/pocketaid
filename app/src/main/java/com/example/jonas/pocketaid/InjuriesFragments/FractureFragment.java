...
public class FractureFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        downloadButton = (Button) rootView.findViewById(R.id.fracture_download);
        videoView = (VideoView) rootView.findViewById(R.id.fracture_video);
        ...
        downloadButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((MainActivity)getActivity()).downloadVideo("Fracture");
            }
        });
    ...
    public void downloadFracture() {
        DownloadManager.Request request = new DownloadManager.Request(Uri.parse(myURL));
        request.setTitle("Fracture Video");
