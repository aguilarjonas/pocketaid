...
public class PunctureFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((MainActivity)getActivity()).setActionBarTitle("Puncture");
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_puncture, container, false);

        //initialization
        downloadNote = (TextView) rootView.findViewById(R.id.download_note);
        downloadButton = (Button) rootView.findViewById(R.id.puncture_download);
        videoView = (VideoView) rootView.findViewById(R.id.puncture_video);
        ...
        downloadButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((MainActivity)getActivity()).downloadVideo("Puncture");
            }
        });
    ...
    public void downloadPuncture() {
        DownloadManager.Request request = new DownloadManager.Request(Uri.parse(myURL));
        request.setTitle("Puncture Video");
